<template>
    <main class="max-w-[52rem] mx-auto px-4 pb-28 sm:px-6 md:px-8 xl:px-12 lg:max-w-6xl">
        <header class="py-16 sm:text-center">
            <h1 class="mb-4 text-3xl sm:text-4xl tracking-tight text-slate-900 font-extrabold dark:text-slate-200">Latest
                Updates</h1>
            <p class="text-lg text-slate-700 dark:text-slate-400">All the latest eVidyaloka news, straight from
                the&nbsp;team.</p>
            <section class="mt-3 max-w-sm sm:mx-auto sm:px-4">
                <h2 class="sr-only">Sign up for our newsletter</h2>
                <form action="https://app.convertkit.com/forms/3181837/subscriptions" method="post"
                    class="flex flex-wrap -mx-2">
                    <div class="px-2 grow-[9999] basis-64 mt-3">
                        <div class="group relative"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            ...
                            </svg><input name="email_address" type="email" required="" autocomplete="email"
                                ...
                                placeholder="Subscribe via email"></div>
                </div>
                <div class="px-2 grow flex mt-3"><button type="submit"
                        class="bg-sky-500 flex-auto shadow text-white rounded-md text-sm border-y border-transparent py-2 font-semibold px-3 hover:bg-sky-600 dark:hover:bg-sky-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-300 dark:focus:ring-offset-slate-900 dark:focus:ring-sky-700">Subscribe</button>
                </div>
            </form>
        </section>
    </header>
    <div
        ...
        <div class="space-y-16">
            <article v-for="i in 10" class="relative group">
                <div
                ...
                <div class="relative">
                    <h3 class="text-base font-semibold tracking-tight text-gray-900 dark:text-slate-900 pt-8 lg:pt-0">
                        Meet Studio: Our beautiful new agency site template</h3>
                    <div class="mt-2 mb-4 prose prose-slate prose-a:relative prose-a:z-10 dark:prose-dark line-clamp-2">
                        <p>We just released <a href="https://tailwindui.com/templates/studio">Studio</a> — a beautiful
                            new agency website template we’ve been working on for the last couple of months for Tailwind
                            UI.</p>
                    </div>
                    <dl class="absolute left-0 top-0 lg:left-auto lg:right-full lg:mr-[calc(6.5rem+1px)]">
                        ...
                        <dd class="whitespace-nowrap text-sm leading-6 dark:text-slate-400"><time
                                datetime="2023-08-07T10:30:00.000Z">August 7, 2023</time></dd>
                    </dl>
                </div><a class="flex items-center text-sm text-sky-500 font-medium"
                    href="/blog/2023-08-07-meet-studio-our-new-agency-template"><span
                        class="absolute -inset-y-2.5 -inset-x-4 md:-inset-y-4 md:-inset-x-6 sm:rounded-2xl"></span><span
                        class="relative">Read more<span class="sr-only">, Meet Studio: Our beautiful new agency site
                            template</span></span><svg
                        class="relative mt-px overflow-visible ml-2.5 text-sky-300 dark:text-sky-700" width="3"
