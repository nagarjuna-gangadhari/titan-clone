...
<template>
    ...
    <h1 class="mb-3 text-center text-6xl font-['Raleway'] font-black">403</h1>
    <h2 class="text-center text-[#455d7a] text-3xl uppercase">Not this time, access forbidden!</h2>
</div></template>