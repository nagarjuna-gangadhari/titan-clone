...
<template>
  <div class="p-20 bg-[#673ab7]">
    <div
      class="grid grid-cols-5 grid-rows-1 grid-flow-row-dense font-mono text-white text-sm text-center font-bold leading-6 bg-stripes-purple rounded-lg">
      <div class="py-2 rounded-lg bg-purple-300 dark:bg-purple-800 dark:text-purple-400"></div>
      <div class="py-2 rounded-lg bg-purple-300 dark:bg-purple-800 dark:text-purple-400"></div>
      <div class="py-2 rounded-lg bg-purple-300 dark:bg-purple-800 dark:text-purple-400"></div>
      <div class="py-2 rounded-lg bg-purple-300 dark:bg-purple-800 dark:text-purple-400"></div>
      <div class="py-2 rounded-lg bg-purple-300 dark:bg-purple-800 dark:text-purple-400"></div>
